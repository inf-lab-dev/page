...
URL="https://inf-lab.dev/watermark/material/lab-watermark.zip"

# the name of the zip file that has been downloaded
ZIP_FILE="lab-watermark.zip"
...
unzip "$ZIP_FILE" -d lab-watermark && rm "$ZIP_FILE"
...
echo -e "${BOLD}   cd lab-watermark${RESET}"
echo -e "${BOLD}   code watermark.c${RESET}"
