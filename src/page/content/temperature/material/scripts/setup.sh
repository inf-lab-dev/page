...
URL="https://inf-lab.dev/temperature/material/lab-temperature.zip"

# the name of the zip file that has been downloaded
ZIP_FILE="lab-temperature.zip"
...
unzip "$ZIP_FILE" -d lab-temperature && rm "$ZIP_FILE"
...
echo -e "${BOLD}   cd lab-temperature${RESET}"
echo -e "${BOLD}   touch temperature.c${RESET}"
echo -e "${BOLD}   code temperature.c${RESET}"
